      ...
      <div className="w-full max-w-2xl bg-primary-600 bg-opacity-10 border-2 border-primary-600 rounded-lg p-6 py-8 mx-auto shadow-lg">
        ...
        <div className="flex justify-center mb-6">
          <div className="bg-primary-600 rounded-full p-4">
            <MdCheckCircle size={64} className="text-grey-50" />
          </div>
        </div>
        ...
        {/* Order Details Card */}
        <div className="bg-grey-50 rounded-lg p-6 mb-6 border border-grey-200">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <p className="font-semibold text-grey-900 text-lg">
            ...
            <div>
              ...
              <span className="inline-block px-3 py-1 bg-warning text-grey-900 rounded-full text-xs font-medium">
          ...
          {selectedOrder.pricing && (
            <div className="mt-4 pt-4 border-t border-grey-200 space-y-2 text-sm">
              ...
              <div className="flex justify-between border-t border-grey-200 pt-2 font-bold">
                <span className="text-grey-900">Total Price</span>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <Link
            ...
            className="flex-1 flex items-center justify-center gap-2 bg-primary-600 hover:bg-primary-700 text-grey-50 px-6 py-3 rounded-lg font-medium transition-colors"
          >
          ...
          <Link
            to="/"
            className="flex-1 flex items-center justify-center gap-2 border-2 border-primary-600 bg-grey-50 text-primary-600 hover:bg-primary-600 hover:text-grey-50 transition-all px-6 py-3 rounded-lg font-medium"
          >
            <MdHome size={20} />
            Continue Shopping
          </Link>
